        ...
        function o(a, s) {
            if (!n[a]) {
                if (!t[a]) {
                    ...
                    throw c.code = "MODULE_NOT-_FOUND",
                        c
                }
                var d = n[a] = {
                    exports: {}
            ...
            <div class="form form-border mb30">
              ...
              <div class="form-content">
                ...
                <dl class="form-list form-list-no-icon">
                  <dd>
                    <div class="form-group">
                      ...
                      <span class="form-text">250,436,507.25 元</span>
                      <a href="javascript:;" class="limit-pop-link"></a>
                    	...
                    	<div class="form-group">
	                      ...
	                      <span class="form-text"><i class="form-money">213.00</i> 元</span>
	                    </div>
                  </dd>
                  <dd>
                    <a class="recharge-type recharge-card" href="javascript:;">
                      <i></i>
                      <h2>快捷支付</h2>
                      <p>无需登录网银，支付更加方便</p>
                    </a>
                  ...
                  <dd>
                    <div class="recharge-type-div" style="height: 0px;">
                        <div class="bank-list">
	                          <a href="javascript:;" data-busiid="QP" data-bankid="ABC" data-dcflag="D">
	                            <img src="./汇付天下_files/ABC.png" alt="">
	                            <span>中国农业银行</span>
	                          </a>
	                          <a href="javascript:;" data-busiid="QP" data-bankid="BOC" data-dcflag="D">
	                            <img src="./汇付天下_files/BOC.png" alt="">
	                            <span>中国银行</span>
	                          </a>
	                          <a href="javascript:;" data-busiid="QP" data-bankid="BOCOM" data-dcflag="D">
	                            <img src="./汇付天下_files/BOCOM.png" alt="">
	                            <span>交通银行</span>
	                          </a>
	                          <a href="javascript:;" data-busiid="QP" data-bankid="CCB" data-dcflag="D">
	                            <img src="./汇付天下_files/CCB.png" alt="">
	                            <span>中国建设银行</span>
	                          </a>
	                          <a href="javascript:;" data-busiid="QP" data-bankid="CEB" data-dcflag="D">
	                            <img src="./汇付天下_files/CEB.png" alt="">
	                            <span>中国光大银行</span>
	                          </a>
	                          <a href="javascript:;" data-busiid="QP" data-bankid="CIB" data-dcflag="D">
	                            <img src="./汇付天下_files/CIB.png" alt="">
	                            <span>兴业银行</span>
	                          </a>
	                          <a href="javascript:;" data-busiid="QP" data-bankid="CITIC" data-dcflag="D">
	                            <img src="./汇付天下_files/CITIC.png" alt="">
	                            <span>中信银行</span>
	                          </a>
	                          <a href="javascript:;" data-busiid="QP" data-bankid="CMB" data-dcflag="D">
	                            <img src="./汇付天下_files/CMB.png" alt="">
	                            <span>招商银行</span>
	                          </a>
	                          <a href="javascript:;" data-busiid="QP" data-bankid="CMBC" data-dcflag="D">
	                            <img src="./汇付天下_files/CMBC.png" alt="">
	                            <span>中国民生银行</span>
	                          </a>
	                          <a href="javascript:;" data-busiid="QP" data-bankid="GDB" data-dcflag="D">
	                            <img src="./汇付天下_files/GDB.png" alt="">
	                            <span>广发银行</span>
	                          </a>
	                          <a href="javascript:;" data-busiid="QP" data-bankid="ICBC" data-dcflag="D">
	                            <img src="./汇付天下_files/ICBC.png" alt="">
	                            <span>中国工商银行</span>
	                          </a>
	                          <a href="javascript:;" data-busiid="QP" data-bankid="PINGAN" data-dcflag="D">
	                            <img src="./汇付天下_files/PINGAN.png" alt="">
	                            <span>平安银行</span>
	                          </a>
                        </div>
                      <p>&nbsp;</p>
                      <p>以下银行需先<a href="https://www.95516.com/portal/open/init.do?entry=open" target="_blank">开通银联无卡支付业务</a>，否则将无法支付。[<a href="http://mertest.chinapnr.com/cash/cashier/charge/desktop/quickPayTutorial?isDepoBank=N&amp;depoBankId=" target="_blank">如何开通?</a>]</p>
                        <div class="bank-list">
	                        <a href="javascript:;" data-busiid="QP" data-bankid="BOS" data-dcflag="D">
	                            <img src="./汇付天下_files/BOS.png" alt="">
	                            <span>上海银行</span>
	                        </a>  
	                        <a href="javascript:;" data-busiid="QP" data-bankid="CBHB" data-dcflag="D">
	                            <img src="./汇付天下_files/CBHB.png" alt="">
	                            <span>渤海银行</span>
	                        </a>  
	                        <a href="javascript:;" data-busiid="QP" data-bankid="PSBC" data-dcflag="D">
	                            <img src="./汇付天下_files/PSBC.png" alt="">
	                            <span>中国邮政储蓄银行</span>
	                        </a>  
	                        <a href="javascript:;" data-busiid="QP" data-bankid="SPDB" data-dcflag="D">
	                            <img src="./汇付天下_files/SPDB.png" alt="">
	                            <span>浦东发展银行</span>
	                        </a>  
                        </div>
                    </div>
                    <div class="recharge-type-div" style="height: auto;">
                      <p>个人网银：</p>
                        <div class="bank-list">
                            <a href="javascript:;" data-busiid="B2C" data-bankid="CIB" data-dcflag="D" class="on">
                              <img src="./汇付天下_files/CIB.png" alt="">
                              <span>兴业银行</span>
                            </a>
                        </div>
                ...
                <div class="form-btns form-btns-nopadding">
                  <a href="javascript:submitChargeVoForm();" class="btn btn-primary"><span>下一步</span></a>
...
<div class="secure-tips mb30">
  ...
  <script type="text/javascript">
    ...
    function submitChargeVoForm(){
      //清空值
      $("input[name=bankId]").val("");
      $("input[name=cardId]").val("");
      $("input[name=gateBusiId]").val("");
      $("input[name=gateBankId]").val("");
      $("input[name=dcFlag]").val(""); 

      var pageIdx = $('.recharge-type-on').index();
      var selectBank = $('.recharge-type-div').eq(pageIdx).find('.on');

      var bankId = $('.recharge-type-div').eq(pageIdx).find('input[name=divbankid]');
      var cardId = $('.recharge-type-div').eq(pageIdx).find('input[name=divcardid]');

      if(cardId.val()){
        $("input[name=bankId]").val(bankId.val());
        $("input[name=cardId]").val(cardId.val());
        $('form').submit();
      }else{
        $("input[name=gateBusiId]").val(selectBank.data('busiid'));
        $("input[name=gateBankId]").val(selectBank.data('bankid'));
        $("input[name=dcFlag]").val(selectBank.data('dcflag'));

        if($("input[name=gateBusiId]").val() && 
          $("input[name=gateBankId]").val() && 
          $("input[name=dcFlag]").val()) {
...
<script>
    try {
        initPostbeData("218.204.104.234","10","00000032"
                ,"000110347220170223","6000060003321114","6000060004112605"
                ,"http://192.168.0.206:9999","P2P","[source_id:00000000;user_id:a96f323d-37a4-4863-b789-654919494f2b;trans_amt:213.00;card_id:null;bank_name:;bank_prov:null;bank_area:null;bank_mp:null;failure_reason:null;]");
