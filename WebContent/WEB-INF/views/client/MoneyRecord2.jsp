...
<div class="account-content">
	...
	<table class="table" style="border: 2px solid; border-color: #DFF0D8;">
			...
			<div>
								<a href="<%=path %>/capital/selectAngodiv1?state=2&page=${witlist.pageNo - 1}"  style="background:#224762;color:white;font-size:15px;border-radius:5px;text-decoration:none;">上一页</a>&nbsp;&nbsp;
								<a href="<%=path %>/capital/selectAngodiv1?state=2&page=${witlist.pageNo + 1}" onclick="mygoods(3)" style="background:#224762;color:white;font-size:15px;border-radius:5px;text-decoration:none;">下一页</a>&nbsp;&nbsp;
