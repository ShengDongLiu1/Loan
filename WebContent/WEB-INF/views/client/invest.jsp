	  ...
	  <div class="invest_con px1000">
	  	     <div class="product_choose">
	  	     	    <h2 class="product_tit clearfix">
	  	     	       ...
	  	     	       <span class="product_curspan"><img src="<%=path %>/images/invest_pic01.png"> 新手体验标</span>
	  	     	       <span><img src="<%=path %>/images/invest_pic02.png"> 项目列表</span>
	  	     	       <span><img src="<%=path %>/images/invest_pic03.png"> 债权转让</span>
	  	     	       </div>
